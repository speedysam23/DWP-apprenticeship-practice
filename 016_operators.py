...
# Subtraction
subtracted = 4 - 2
print(f"4-2 =  {subtracted} (should be 2)")

# Division
divided = 10 / 2
print(f"10 / 2 = {divided} (should be 5)")

# Floor division
FD = 10//9
print(F"10//9 = {FD} (should be 1)")

# Modulus
modulus = 10 % 3 
print(f"10 % 3 = {modulus} (should be 1)")
# Exponentiation
exponentiation = 3**3
print(f"3 ** 3 = {exponentiation} (should be 27)")
